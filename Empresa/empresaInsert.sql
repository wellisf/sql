insert into Empregado(nome, sobrenome, cpf, nascimento, endereco, sexo, salario,cpfsuper,cddepartamento) values 
('João','Smith', 123456789,'09/01/1965','R.Casimiro de Abreu,30,RJ','M',30000,333445555,5),
('Francisco','Gomes', 333445555,'08/12/1955','R.Buarque,430,RJ','M',40000,888665555,5),
('Alicia','Foly', 999887777,'19/07/1968','R.Matriz,250,RJ','F',25000,987654321,4),
('Jennifer','Cardoso', 987654321,'20/06/1941','R.Niterói,67,RJ','F',43000,888665555,4),
('Adriano','Matias',666884444,'15/09/1962','R. Duque Estrada, 23, RJ','M',38000,333445555,5),
('Joyce','Vianna',453453453,'31/07/1972','R. General Osório, 45, RJ','F',25000,333445555,5),
('Leonardo','Rangel',987987987,'29/03/1969','R. Osvaldo Cruz, 81, RJ','M',25000,987654321,4),
('Diogo','Poly',888665555,'10/11/1937','R. Maria Guimarães, 65, RJ','M',55000,null,1);
