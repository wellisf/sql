CREATE DATABASE  IF NOT EXISTS `carn` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `carn`;
-- MySQL dump 10.13  Distrib 5.7.16, for Linux (x86_64)
--
-- Host: localhost    Database: carn
-- ------------------------------------------------------
...
CREATE TABLE `Integrante` (
  ...
  `estado` enum('RJ','SP') DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `Julgar` (
  ...
  CONSTRAINT `Julgar_ibfk_1` FOREIGN KEY (`id`) REFERENCES `Integrante` (`id`),
...
INSERT INTO `Setores` VALUES (1,'A',70,26000,2),(2,'J',50,49081,2),(3,'Arquibancadas',100,21084,2),(4,'Pista',120,208015,2),(5,'Espaço Anhembi',500,11755,2),(6,'Arena Anhembi',250,49936,2),(7,'Nova Arena',350,38095,2);
...
-- Dump completed on 2016-11-28 10:32:44
